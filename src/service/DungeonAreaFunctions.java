...
public class DungeonAreaFunctions implements IPWService<DungeonAreaClass>, IDungeonServices<DungeonAreaClass> {
    ...
    @Override
    public void showDungeonOptions(Scanner dataInput, DungeonAreaClass area, DungeonClass dungeon) {
        int option = 0;
